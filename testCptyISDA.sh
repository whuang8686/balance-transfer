...
TRX_ID=$(curl -s -X POST \
  ...
  -d '{
	...
	"fcn":"createCptyISDA",
	"args":["0001","0005","0","0","35000000","8000000","3000000","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo

echo "4.createCptyISDA"
echo
TRX_ID=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"createCptyISDA",
	"args":["0002","0001","0","0","25000000","6000000","3000000","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo

echo "5.createCptyISDA"
echo
TRX_ID=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"createCptyISDA",
	"args":["0002","0008","0","0","45000000","7000000","3000000","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo

echo "6.createCptyISDA"
echo
TRX_ID=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  ...
  "peers": ["peer0.org1.example.com","peer1.org1.example.com"],
  "fcn":"createCptyISDA",
  "args":["0005","0001","0","0","45000000","7000000","3000000","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo

echo "7.createCptyISDA"
echo
TRX_ID=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  ...
  "peers": ["peer0.org1.example.com","peer1.org1.example.com"],
  "fcn":"createCptyISDA",
  "args":["0001","0002","0","0","45000000","7000000","3000000","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo
