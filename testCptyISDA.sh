...
TRX_ID=$(curl -s -X POST \
  ...
  -d '{
	...
	"fcn":"createCptyISDA",
	"args":["0001","0005","0","0","35000000","80","100","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
...
TRX_ID=$(curl -s -X POST \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"createCptyISDA",
	"args":["0002","0001","0","0","25000000","600","200","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo
...
TRX_ID=$(curl -s -X POST \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"createCptyISDA",
	"args":["0002","0008","0","0","45000000","70000","400","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo
...
TRX_ID=$(curl -s -X POST \
  ...
  "peers": ["peer0.org1.example.com","peer1.org1.example.com"],
  "fcn":"createCptyISDA",
  "args":["0005","0001","0","0","45000000","70","200","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo
...
TRX_ID=$(curl -s -X POST \
  ...
  "peers": ["peer0.org1.example.com","peer1.org1.example.com"],
  "fcn":"createCptyISDA",
  "args":["0001","0002","0","0","45000000","7000","700","500000","100000","2018/01/01","2020/12/31","1","0.95","0.96","0.89"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo
