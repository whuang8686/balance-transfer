...
TRX_ID=$(curl -s -X POST \
  ...
  -d '{
	...
	"fcn":"FXTradeTransfer",
	"args":["B","0001","0003","2018/02/01","2018/10/31","USD/TWD","USD","2000000","TWD","1000000","30","true","0001B20180910132930"]
}')
...
echo
curl -s -X GET \
  "http://localhost:4000/channels/mychannel/chaincodes/mycc?peer=peer0.org1.example.com&fcn=getHistoryForTransaction&args=%5B%220001B20180910132930%22%5D" \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json"
echo
echo
