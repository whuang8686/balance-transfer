...
TRX_ID=$(curl -s -X POST \
  ...
  -d '{
	...
	"fcn":"createCptyAsset",
	"args":["0002","45000000","8000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo

echo "4.createCptyAsset"
echo
TRX_ID=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"createCptyAsset",
	"args":["0001","45000000","8000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo

echo "5.createCptyAsset"
echo
TRX_ID=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"createCptyAsset",
	"args":["0003","35000000","8000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000","6000000"]
}')
echo "Transacton ID is $TRX_ID"
echo
echo
...
echo
curl -s -X GET \
  "http://localhost:4000/channels/mychannel/chaincodes/mycc?peer=peer0.org1.example.com&fcn=queryCptyISDAStatus&args=%5B%22All%22%5D" \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json"
echo
echo
