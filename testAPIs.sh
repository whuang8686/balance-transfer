...
echo "10.GET query Transaction by TransactionID"
echo
...
echo "12.GET query Installed chaincodes"
echo
curl -s -X GET \
...
echo "13.GET query Instantiated chaincodes"
echo
curl -s -X GET \
