...
echo
curl -s -X GET \
  "http://localhost:4000/channels/mychannel/chaincodes/mycc?peer=peer0.org1.example.com&fcn=queryCollateralTransactionStatus&args=%5B%2220181121%22%2C%220001%22%5D" \
